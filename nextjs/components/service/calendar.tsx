    ...
    return (
        <div className="flex">
            <div className="flex-1">
                <div className="m-4 bg-secondary rounded-xl p-4 shadow-sm">
                    <FullCalendar
                        plugins={[
                            dayGridPlugin,
                            interactionPlugin,
            ...
            <div id="draggable-el" className="bg-secondary rounded-xl shadow-sm p-4 m-4">
                                ...
                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                                    ...
                                    sm:text-sm sm:leading-6"
                                                ...
                                                <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                                    <button
                                                        type="submit"
                                                        className="inline-flex w-full justify-center rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 sm:col-start-2 disabled:opacity-25"
